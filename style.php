...
<!--		    <a href="http://www.footdisc.com.tw" target="_blank"><img src="images/btn_logo.png" name="logo" width="137" height="21" border="0" id="logo" /></a>-->
        ...
        <a href="style.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','images/btn_active2.png',1)"><img src="images/btn_active2.png" name="Image4" width="110" height="21" border="0" id="Image4" /></a>
      ...
      <br />
		<img src="images/herfr-style-02-btn.png" name="page" width="95" height="24.5" id="page" /></div>
</div>
<div class="maim_frame"><img src="images/style.jpg" name="style" width="1080" height="2307" id="style" border="0" /></div>
